...
export const projects: Project[] = [
  ...
  {
    title: "Multi-Region Website & Content Administration System",
    description:
      "A fully responsive marketing website and custom CMS-driven admin panel for a client operating across multiple countries, requiring multilingual content and dynamic content management.",
    highlights: [
      "Custom admin panel with CMS-driven content management",
      "Dynamic content & location pages with server-side rendering",
      "Multi-region brand guidelines with pixel-perfect Figma implementation",
